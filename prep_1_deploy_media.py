...
# 4. OBSERVATIONS: 
  ...
  # 4A. Generate Observation google docs
  # 4B. Fill in Obs. google docs
  # 4C. Convert Obs to CSV (or otherwise add to table wherever that table is / Mongo? etc?)


# 5. CAMTRAP-DP + METADATA?
